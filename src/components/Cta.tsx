...
export const Cta = () => {
  return (
    <Container>
      <div className="flex flex-wrap items-center justify-between w-full max-w-4xl gap-5 mx-auto text-white bg-colores-boton2 px-7 py-7 lg:px-12 lg:py-12 lg:flex-nowrap rounded-xl">
