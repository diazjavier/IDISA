...
import docImage from "../../public/img/doctor_1.jpg";
      ...
      <Container className="flex flex-wrap">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl m-8">
            <h1 className="text-6xl font-bold leading-snug tracking-tight text-indigo-900 lg:text-6xl lg:leading-tight xl:text-8xl xl:leading-tight dark:text-white">
              IDISA
            </h1>
            <h3 className="italic text-base font-bold leading-snug tracking-tight text-indigo-900 lg:leading-tight xl:leading-tight dark:text-white">
            ...
            <p className="py-5 text-lg lg:text-xl leading-normal text-gray-500 dark:text-gray-300">
              En IDISA, creemos que la ciencia puede transformar el mundo,
              especialmente cuando es independiente y está comprometida con el
              bienestar público. Llevamos adelante investigaciones rigurosas en
              salud pública que no están influenciadas por intereses
              comerciales, políticos o académicos.
            </p>
