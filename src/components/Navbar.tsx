...
export const Navbar = () => {
  ...
  return (
    <div className="w-full shadow-lg hover:shadow-xl bg-fondoNavBar dark:bg-trueGray-950">
      <nav className="container relative flex flex-wrap items-center justify-between p-2 mx-auto lg:justify-between xl:px-1">
        ...
        <div className="gap-3 nav__item mr-2 lg:flex ml-auto lg:ml-0 lg:order-2">
            ...
            <div className="hidden mr-3 lg:flex nav__item">
              <Link href="/contacts" className="px-6 py-2 text-white bg-colores-boton hover:bg-colores-botonHover rounded-md md:ml-5">
                Contacto
              </Link>
            </div>
        </div>
            ...
            <>
                ...
                <DisclosurePanel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    ...
                    <Link href="/contacts" onClick={() => {close()}} className="w-full px-6 py-2 mt-3 text-center text-white bg-colores-boton hover:bg-colores-botonHover rounded-md lg:ml-5">         
                        Contacto
                    </Link>
